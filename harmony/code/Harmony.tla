...
Step(self) == \/ self.pc = 0 /\ OpFrame(self, "__init__", VList(<<  >>))
              ...
              \/ self.pc = 3 /\ OpPush(self, Address(HPc(-1), <<HStr("turn")>>))
              \/ self.pc = 4 /\ OpSequential(self)
              \/ self.pc = 5 /\ OpPush(self, Address(HPc(-1), <<HStr("lockTaken")>>))
              \/ self.pc = 6 /\ OpSequential(self)
              \/ self.pc = 7 /\ OpPush(self, Address(HPc(-1), <<HStr("flags")>>))
              \/ self.pc = 8 /\ OpSequential(self)
              \/ self.pc = 9 /\ OpPush(self, HInt(0))
              \/ self.pc = 10 /\ OpStore(self, <<HStr("turn")>>)
              \/ self.pc = 11 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 12 /\ OpStore(self, <<HStr("lockTaken")>>)
              \/ self.pc = 13 /\ OpPush(self, HList(<<>>))
              \/ self.pc = 14 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 15 /\ OpListAdd(self)
              \/ self.pc = 16 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 17 /\ OpListAdd(self)
              \/ self.pc = 18 /\ OpStore(self, <<HStr("flags")>>)
              \/ self.pc = 19 /\ OpPush(self, HInt(0))
              \/ self.pc = 20 /\ OpStore(self, <<HStr("counter")>>)
              \/ self.pc = 21 /\ OpJump(self, 189)
              \/ self.pc = 22 /\ OpFrame(self, "fail0", VName("p_q"))
              \/ self.pc = 23 /\ OpDelVar(self, VName("p_q"))
              \/ self.pc = 24 /\ OpPush(self, HSet({}))
              \/ self.pc = 25 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 26 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 27 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 28 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 29 /\ OpChoose(self)
              \/ self.pc = 30 /\ OpJumpCond(self, 44, HBool(FALSE))
              \/ self.pc = 31 /\ OpAtomicInc(self)
              \/ self.pc = 32 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 33 /\ OpPush(self, HInt(1))
              \/ self.pc = 34 /\ OpNary(self, FunAdd, 2)
              \/ self.pc = 35 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 36 /\ OpAtomicDec(self)
              \/ self.pc = 37 /\ OpAtomicInc(self)
              \/ self.pc = 38 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 39 /\ OpPush(self, HInt(1))
              \/ self.pc = 40 /\ OpBin(self, FunSubtract)
              \/ self.pc = 41 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 42 /\ OpAtomicDec(self)
              \/ self.pc = 43 /\ OpJump(self, 23)
              \/ self.pc = 44 /\ OpReturnVarDefault(self, "result", None)
              \/ self.pc = 45 /\ OpJump(self, 189)
              \/ self.pc = 46 /\ OpFrame(self, "fail1", VName("p_q"))
              \/ self.pc = 47 /\ OpDelVar(self, VName("p_q"))
              \/ self.pc = 48 /\ OpPush(self, HSet({}))
              \/ self.pc = 49 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 50 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 51 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 52 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 53 /\ OpChoose(self)
              \/ self.pc = 54 /\ OpJumpCond(self, 77, HBool(FALSE))
              \/ self.pc = 55 /\ OpLoad(self, HStr("lockTaken"))
              \/ self.pc = 56 /\ OpUna(self, FunNot)
              \/ self.pc = 57 /\ OpJumpCond(self, 55, HBool(FALSE))
              \/ self.pc = 58 /\ OpJump(self, 60)
              \/ self.pc = 59 /\ OpJump(self, 55)
              \/ self.pc = 60 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 61 /\ OpStore(self, <<HStr("lockTaken")>>)
              \/ self.pc = 62 /\ OpAtomicInc(self)
              \/ self.pc = 63 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 64 /\ OpPush(self, HInt(1))
              \/ self.pc = 65 /\ OpNary(self, FunAdd, 2)
              \/ self.pc = 66 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 67 /\ OpAtomicDec(self)
              \/ self.pc = 68 /\ OpAtomicInc(self)
              \/ self.pc = 69 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 70 /\ OpPush(self, HInt(1))
              \/ self.pc = 71 /\ OpBin(self, FunSubtract)
              \/ self.pc = 72 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 73 /\ OpAtomicDec(self)
              \/ self.pc = 74 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 75 /\ OpStore(self, <<HStr("lockTaken")>>)
              \/ self.pc = 76 /\ OpJump(self, 47)
              \/ self.pc = 77 /\ OpReturnVarDefault(self, "result", None)
              \/ self.pc = 78 /\ OpJump(self, 189)
              \/ self.pc = 79 /\ OpFrame(self, "fail2", VName("p_q"))
              \/ self.pc = 80 /\ OpPush(self, HSet({}))
              \/ self.pc = 81 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 82 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 83 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 84 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 85 /\ OpChoose(self)
              \/ self.pc = 86 /\ OpJumpCond(self, 110, HBool(FALSE))
              \/ self.pc = 87 /\ OpPush(self, HInt(1))
              \/ self.pc = 88 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 89 /\ OpBin(self, FunSubtract)
              \/ self.pc = 90 /\ OpStore(self, <<HStr("turn")>>)
              \/ self.pc = 91 /\ OpLoad(self, HStr("turn"))
              \/ self.pc = 92 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 93 /\ OpBin(self, FunEquals)
              \/ self.pc = 94 /\ OpJumpCond(self, 91, HBool(FALSE))
              \/ self.pc = 95 /\ OpJump(self, 97)
              \/ self.pc = 96 /\ OpJump(self, 91)
              \/ self.pc = 97 /\ OpAtomicInc(self)
              \/ self.pc = 98 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 99 /\ OpPush(self, HInt(1))
              \/ self.pc = 100 /\ OpNary(self, FunAdd, 2)
              \/ self.pc = 101 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 102 /\ OpAtomicDec(self)
              \/ self.pc = 103 /\ OpAtomicInc(self)
              \/ self.pc = 104 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 105 /\ OpPush(self, HInt(1))
              \/ self.pc = 106 /\ OpBin(self, FunSubtract)
              \/ self.pc = 107 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 108 /\ OpAtomicDec(self)
              \/ self.pc = 109 /\ OpJump(self, 80)
              \/ self.pc = 110 /\ OpDelVar(self, VName("p_q"))
              \/ self.pc = 111 /\ OpReturnVarDefault(self, "result", None)
              \/ self.pc = 112 /\ OpJump(self, 189)
              \/ self.pc = 113 /\ OpFrame(self, "fail3", VName("p_q"))
              \/ self.pc = 114 /\ OpPush(self, HSet({}))
              \/ self.pc = 115 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 116 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 117 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 118 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 119 /\ OpChoose(self)
              \/ self.pc = 120 /\ OpJumpCond(self, 154, HBool(FALSE))
              \/ self.pc = 121 /\ OpPush(self, Address(HPc(-1), <<HStr("flags")>>))
              \/ self.pc = 122 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 123 /\ OpBin(self, FunAddArg)
              \/ self.pc = 124 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 125 /\ OpStoreInd(self)
              \/ self.pc = 126 /\ OpPush(self, Address(HPc(-1), <<HStr("flags")>>))
              \/ self.pc = 127 /\ OpPush(self, HInt(1))
              \/ self.pc = 128 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 129 /\ OpBin(self, FunSubtract)
              \/ self.pc = 130 /\ OpBin(self, FunAddArg)
              \/ self.pc = 131 /\ OpLoadInd(self)
              \/ self.pc = 132 /\ OpUna(self, FunNot)
              \/ self.pc = 133 /\ OpJumpCond(self, 126, HBool(FALSE))
              \/ self.pc = 134 /\ OpJump(self, 136)
              \/ self.pc = 135 /\ OpJump(self, 126)
              \/ self.pc = 136 /\ OpAtomicInc(self)
              \/ self.pc = 137 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 138 /\ OpPush(self, HInt(1))
              \/ self.pc = 139 /\ OpNary(self, FunAdd, 2)
              \/ self.pc = 140 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 141 /\ OpAtomicDec(self)
              \/ self.pc = 142 /\ OpAtomicInc(self)
              \/ self.pc = 143 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 144 /\ OpPush(self, HInt(1))
              \/ self.pc = 145 /\ OpBin(self, FunSubtract)
              \/ self.pc = 146 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 147 /\ OpAtomicDec(self)
              \/ self.pc = 148 /\ OpPush(self, Address(HPc(-1), <<HStr("flags")>>))
              \/ self.pc = 149 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 150 /\ OpBin(self, FunAddArg)
              \/ self.pc = 151 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 152 /\ OpStoreInd(self)
              \/ self.pc = 153 /\ OpJump(self, 114)
              \/ self.pc = 154 /\ OpDelVar(self, VName("p_q"))
              \/ self.pc = 155 /\ OpReturnVarDefault(self, "result", None)
              \/ self.pc = 156 /\ OpJump(self, 189)
              \/ self.pc = 157 /\ OpFrame(self, "fail4", VName("p_q"))
              \/ self.pc = 158 /\ OpPush(self, HSet({}))
              \/ self.pc = 159 /\ OpPush(self, HBool(FALSE))
              \/ self.pc = 160 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 161 /\ OpPush(self, HBool(TRUE))
              \/ self.pc = 162 /\ OpBin(self, FunSetAdd)
              \/ self.pc = 163 /\ OpChoose(self)
              \/ self.pc = 164 /\ OpJumpCond(self, 187, HBool(FALSE))
              \/ self.pc = 165 /\ OpLoad(self, HStr("turn"))
              \/ self.pc = 166 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 167 /\ OpBin(self, FunEquals)
              \/ self.pc = 168 /\ OpJumpCond(self, 170, HBool(TRUE))
              \/ self.pc = 169 /\ OpJump(self, 165)
              \/ self.pc = 170 /\ OpAtomicInc(self)
              \/ self.pc = 171 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 172 /\ OpPush(self, HInt(1))
              \/ self.pc = 173 /\ OpNary(self, FunAdd, 2)
              \/ self.pc = 174 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 175 /\ OpAtomicDec(self)
              \/ self.pc = 176 /\ OpAtomicInc(self)
              \/ self.pc = 177 /\ OpLoad(self, HStr("in_cs"))
              \/ self.pc = 178 /\ OpPush(self, HInt(1))
              \/ self.pc = 179 /\ OpBin(self, FunSubtract)
              \/ self.pc = 180 /\ OpStore(self, <<HStr("in_cs")>>)
              \/ self.pc = 181 /\ OpAtomicDec(self)
              \/ self.pc = 182 /\ OpPush(self, HInt(1))
              \/ self.pc = 183 /\ OpLoadVar(self, VName("p_q"))
              \/ self.pc = 184 /\ OpBin(self, FunSubtract)
              \/ self.pc = 185 /\ OpStore(self, <<HStr("turn")>>)
              \/ self.pc = 186 /\ OpJump(self, 158)
              \/ self.pc = 187 /\ OpDelVar(self, VName("p_q"))
              \/ self.pc = 188 /\ OpReturnVarDefault(self, "result", None)
              \/ self.pc = 189 /\ OpPush(self, Address(HPc(79), <<>>))
              \/ self.pc = 190 /\ OpPush(self, HInt(0))
              \/ self.pc = 191 /\ OpBin(self, FunAddArg)
              \/ self.pc = 192 /\ OpPush(self, EmptyDict)
              \/ self.pc = 193 /\ OpSpawn(self)
              \/ self.pc = 194 /\ OpPush(self, Address(HPc(79), <<>>))
              \/ self.pc = 195 /\ OpPush(self, HInt(1))
              \/ self.pc = 196 /\ OpBin(self, FunAddArg)
              \/ self.pc = 197 /\ OpPush(self, EmptyDict)
              \/ self.pc = 198 /\ OpSpawn(self)
              \/ self.pc = 199 /\ OpReturnVarDefault(self, "result", None)
              \/ self.pc = 200 /\ OpDelVar(self, VName("result"))
